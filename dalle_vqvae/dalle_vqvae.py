...
class VQVAE(nn.Module):
    ...
    def forward(
        ...
        encoded = self.encoder(img) #[bs, 3, 32, 32] --> [bs, 512, 4, 4]
        ...
        quantized = rearrange(quantized, 'b t c -> b c t', t = t) #[bs, 16, 512] --> [bs, 512, 4, 4]
        ...
        return out, recon_loss, commit_loss
...
class EuclideanCodebook(nn.Module):
    ...
    def forward(self, x):
        ...
        return quantize, embed_ind #[bs, 16, 512], [bs, 16]
...
class VectorQuantize(nn.Module):
    ...
    def forward(
        ...
        if self.training:
            quantize = x + (quantize - x).detach() #[64, 204, 512]
